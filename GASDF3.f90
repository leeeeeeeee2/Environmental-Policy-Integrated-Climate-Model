...
!     THIS PROGRAM SOLVES THE GAS DIFFUSION EQUATION
      ...
      XTP13(30),XTP14(30),XTP15(30),XTP16(30),XTP17(30),XTP18(30),XTP19(30)
...
!     CLOC,CUPN,CLON/279.,240.,.18,10.,.00018,1./
      ...
      CALL AINTRI(XTP19,WNH3,NBSL,NBCL)
      CALL AINTRI(FC,VFC,NBSL,NBCL)
      CALL ICECALC(0,SOT,VWC,TPOR)
      AD4=0.
      AD5=0.
      AD6=0.
      TOT2=0.
      ...
      (AFP(K),K=1,NBCL),(WNH3(K),K=1,NBCL),(WNO3(K),K=1,NBCL),(WNO2(K),&
      K=1,NBCL),(WO2L(K),K=1,NBCL),(WO2G(K),K=1,NBCL),(DO2CONS(K),K=1,&
      NBCL),DFO2S,DFO2B,DFO2T,QO2,(SSFO2(K),K=1,NBCL),(VO2(K),K=1,NBCL),&
      (WCO2L(K),K=1,NBCL),(WCO2G(K),K=1,NBCL),(DCO2GEN(K),K=1,NBCL),&
      DFCO2S,DFCO2B,DFCO2T,QCO2,(SSFCO2(K),K=1,NBCL),(VCO2(K),K=1,NBCL),&
      (WN2OL(K),K=1,NBCL),(WN2OG(K),K=1,NBCL),DFN2OS,DFN2OB,DFN2OT,QN2O,&
      (SSFN2O(K),K=1,NBCL),(VN2O(K),K=1,NBCL),(DN2OG(K),K=1,NBCL),&
      (DN2G(K),K=1,NBCL),(SMEA(K),K=1,NBCL),(SMES(K),K=1,NBCL),(EAR(K),&
      K=1,NBCL)
      CALL ICECALC(1,SOT,VWC,TPOR)
      ...
      CALL AINTRO(XTP11,WO2G,NBSL,NBCL)
      CALL AINTRO(XTP12,WO2L,NBSL,NBCL)
      CALL AINTRO(XTP13,WCO2G,NBSL,NBCL)
      CALL AINTRO(XTP15,WCO2L,NBSL,NBCL)
      CALL AINTRO(XTP14,SSFN2O,NBSL,NBCL)
      CALL AINTRO(XTP17,VN2O,NBSL,NBCL)
      CALL AINTRO(XTP19,WNH3,NBSL,NBCL)
      !CALL AINTRO(XTP8,DN2G,NBSL,NBCL)
      !CALL AINTRO(XTP9,DN2OG,NBSL,NBCL)
